...
const char* wifi_ssid = "la ratiera";
const char* wifi_password = "swing000";
...
const char* client_id = "TD01_GP03";
...
void setup() {
  ...
  mqtt_client.publish("TD01_GP03/temp", String(event.temperature).c_str());
  mqtt_client.publish("TD01_GP03/relhum", String(event.temperature).c_str());
